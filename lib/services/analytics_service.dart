...
class AnalyticsService {
  ...
  /// This is auto-generated by Countly SDK, not linked to any personal data
  Future<String?> getDeviceId() async {
    if (!_initialized) return null;

    try {
      // Get the actual device ID from Countly SDK
      final deviceId = await Countly.getCurrentDeviceId();
      return deviceId;
    } catch (e) {
